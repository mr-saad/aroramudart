    ...
    <Link className="uppercase relative" href={`/products/${slug}`}>
      <div className="overflow-hidden group flex justify-center items-center aspect-square bg-[#f4f4f4]">
        <Image
          ...
          className="w-[80%] shadow-lg shadow-black/20 will-change-transform object-contain select-none group-hover:scale-105 transition-transform duration-1000 ease-out"
          placeholder="blur"
          blurDataURL={lqip}
          width={400}
          height={400}
